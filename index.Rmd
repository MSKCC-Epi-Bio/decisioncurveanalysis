...
Decision curve analysis is a statistical method that evaluates models and tests in terms of their clinical consequences. This is unlike traditional accuracy measure - such as the area-under-the-curve or Brier score - which do not take into account considerations such as, for instance, it being worse to miss a cancer (false negative) than do an unnecessary biopsy (false positive). Decision curve analysis evaluates the net benefit of a model or test in comparison to the two default strategies of treat all patients and treat no patients.
